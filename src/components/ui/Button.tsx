...
export const Button = React.forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(
  ({ className, variant = "primary", href, children, ...props }, ref) => {
    ...
    const variants = {
      primary: "h-12 px-8 bg-brand-btn-primary hover:bg-brand-btn-hover text-brand-primary font-medium text-base border-0 rounded-none disabled:bg-[#D7CAC1] disabled:text-[#BFAB9C] disabled:cursor-not-allowed active:bg-[#A8894E]",
