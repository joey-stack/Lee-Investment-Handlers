              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3" noValidate>
                <div className="flex flex-col gap-2">
                  <input
                    ...
                    className={cn(
                      "h-12 px-4 bg-white text-brand-primary border rounded-[6px] text-sm font-medium focus:outline-none focus:border-brand-alternate placeholder-[#BFAB9C] w-full transition-all duration-250",
