  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 pt-4 px-4 md:px-6">
        {/* Floating card */}
        <div className="max-w-[1200px] mx-auto bg-brand-bg-alternate rounded-none shadow-[0_8px_32px_rgba(0,0,0,0.5)] h-[80px] px-5 md:px-7 flex items-center justify-between">
