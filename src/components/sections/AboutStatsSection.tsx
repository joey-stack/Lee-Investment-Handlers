    ...
    <section className="bg-brand-bg-primary py-20 md:py-28 border-b border-brand-border">
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-16 select-none">
          <h2 className="font-heading text-4xl md:text-[56px] text-brand-secondary/15 font-normal leading-none tracking-tight text-balance uppercase animate-fade-up-delay-1">
