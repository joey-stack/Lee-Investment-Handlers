...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenConsultation }) => {
  ...
  return (
    <section className="relative w-full h-[100dvh] min-h-[600px] flex items-center justify-center overflow-hidden bg-[#0A0A0A] select-none">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 w-full overflow-hidden text-[11px] md:text-[13px] uppercase tracking-[0.2em] text-white/80 font-body font-semibold select-none animate-fade-up-delay-4">
