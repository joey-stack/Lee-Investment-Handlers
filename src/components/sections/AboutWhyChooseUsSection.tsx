  ...
  return (
    <section className="bg-brand-bg-primary py-20 md:py-28 border-b border-brand-border">
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div className="bg-brand-bg-alternate text-white rounded-[6px] p-8 md:p-12 mb-8 flex flex-col lg:flex-row lg:items-end justify-between gap-6 animate-fade-up">
          <div className="max-w-2xl">
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-normal leading-[1.2] tracking-tight text-white text-balance animate-fade-up-delay-1">
              {aboutWhyChooseUsContent.headline}
            </h2>
          </div>
          <p className="font-body text-base text-white/70 leading-relaxed max-w-sm lg:mb-1 animate-fade-up-delay-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {aboutWhyChooseUsContent.items.map((item) => (
            <div
              key={item.number}
              className="bg-brand-bg-secondary border border-brand-border/40 rounded-[6px] p-6 md:p-8 flex flex-col justify-between shadow-[0px_2px_8px_rgba(0,0,0,0.01)] hover:shadow-[0px_8px_24px_rgba(10,10,10,0.04)] transition-all duration-300 min-h-[220px] animate-fade-up-delay-4 hover:-translate-y-1"
            >
              <div>
