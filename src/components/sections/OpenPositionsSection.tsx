  ...
  return (
    <section className="bg-brand-bg-primary py-20 md:py-24">
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        {/* Empty State Card */}
        <div className="max-w-3xl mx-auto bg-brand-bg-secondary border border-dashed border-brand-border rounded-[6px] p-8 md:p-12 text-center flex flex-col items-center animate-fade-up-delay-4">
          {/* Icon */}
          ...
          {/* Title */}
          <h3 className="font-heading text-xl md:text-2xl font-normal text-brand-primary mb-4 animate-fade-up-delay-1">
            {openPositionsCopy.emptyStateTitle}
          </h3>

          {/* Explanation */}
          <p className="font-body text-sm md:text-base text-brand-secondary leading-relaxed max-w-lg mb-8 animate-fade-up-delay-2">
            {openPositionsCopy.emptyStateText}
          </p>

          {/* Sub CTA details */}
          <div className="border-t border-brand-border/60 pt-8 w-full max-w-md animate-fade-up-delay-3">
